...
Generated date: 2026-07-22T15:16:31.118320+00:00
"""
...
ENGINE_EXCEPTION_MAP = {
    ...
    38: SzNotFoundError,                    # EAS_ERR_RECORD_HAS_NO_RESOLVED_ENTITY                                                 "Data source record has no resolved entity: dsrc[{0}], recordID[{1}]"
    39: SzNotFoundError,                    # EAS_ERR_NO_OBSERVED_ENTITY_FOR_DSRC_ENTITY_KEY                                        "No observed entity for entity key: dsrc[{0}], record_id[{1}], key[{2}]"
    ...
    48: SzNotInitializedError,              # EAS_ERR_SZ_NOT_INITIALIZED                                                            "SDK is not initialized"
    49: SzNotInitializedError,              # EAS_ERR_SZCORE_ALREADY_INITIALIZED                                                    "SzCore is already initialized - call SzCore::destroy() first"
    50: SzNotInitializedError,              # EAS_ERR_SZCORE_NOT_INITIALIZED                                                        "SzCore is not initialized - call SzCore::init() first"
    ...
    53: SzNotInitializedError,              # EAS_ERR_RECORD_ID_REQUIRED                                                            "RECORD_ID must be provided"
    ...
    58: SzError,                            # EAS_ERR_SZ_INITIALIZATION_FAILURE                                                     "Sz initialization process has failed"
    ...
    61: SzConfigurationError,               # EAS_ERR_AMBIGUOUS_SUPPRESSED_LIBFEAT_FELEM_MISSING                                    "AMBIGUOUS_SUPPRESSED_LIBFEAT Feature Element is not configured"
    ...
    87: SzUnhandledError,                   # EAS_ERR_SZ_EXCEPTION                                                                  "Sz Exception '{0}'"
    ...
    93: SzError,                            # EAS_ERR_CONFUSED_ENTITY_FELEM_MISSING                                                 "YESNO_FLAG Feature Element is not configured"
    94: SzError,                            # EAS_ERR_DOMAIN_NAME_FELEM_MISSING                                                     "DOMAIN_NAME Feature Element is not configured"
    95: SzError,                            # EAS_ERR_SUPPRESSED_RELATIONSHIP_FTYPE_ID_FELEM_MISSING                                "SUPPRESSED_RELATIONSHIP_FTYPE_ID Feature Element is not configured"
    96: SzError,                            # EAS_ERR_SUPPRESSED_RELATIONSHIP_CONNECTING_FTYPE_ID_FELEM_MISSING                     "SUPPRESSED_RELATIONSHIP_CONNECTING_FTYPE_ID Feature Element is not configured"
    97: SzError,                            # EAS_ERR_ORPHANED_ENTITY_FTYPE_MISSING                                                 "ORPHANED_ENTITY Feature Type is not configured"
    98: SzError,                            # EAS_ERR_ORPHANED_ENTITY_FELEM_MISSING                                                 "VALUE Feature Element is not configured"
    999: SzLicenseError,                    # EAS_ERR_LICENSE_HAS_EXPIRED                                                           "License has expired. {0}"
    ...
    1021: SzDatabaseError,                  # EAS_ERR_PREPARED_STATEMENT_ERROR                                                      "Prepared statement error '{0}'"
    ...
    2114: SzConfigurationError,             # EAS_ERR_INVALID_FTYPE_SCORESET                                                        "Cannot set score for invalid feature type ID [{0}]"
    ...
    2124: SzError,                          # EAS_ERR_FEATURE_CONFIGURED_WITH_ONLY_DERIVED_FELEMS                                   "Feature [{0}] configured with only derived felems"
    2131: SzConfigurationError,             # EAS_ERR_OBS_ENT_NOT_FOUND                                                             "Requested resolution of observed entity that is not loaded:  OBS_ENT_ID[{0}]"
    ...
    2139: SzConfigurationError,             # EAS_ERR_DSRC_INTEREST_CONFIGURED_WITH_INVALID_DSRCID                                  "Data Source Interest configured with invalid Data Source ID [{0}]"
    2205: SzConfigurationError,             # EAS_ERR_FTYPE_ID_DOES_NOT_EXIST                                                       "Feature type ID [{0}] does not exist."
    2206: SzConfigurationError,             # EAS_ERR_DATA_SOURCE_ID_DOES_NOT_MATCH                                                 "Data source ID [{0}] [{1}] does not match."
    ...
    3124: SzError,                          # EAS_ERR_JSON_DATA_IS_NULL                                                             "JSON record data cannot be null."
    3125: SzError,                          # EAS_ERR_JSON_RECORD_DATA_MUST_BE_OBJECT                                               "JSON record data must be an object, not an array."
    ...
    8503: SzError,                          # EAS_ERR_SALT_DIGEST_CONTEXT_INIT_FAILED                                               "Failed {0} to initialize a digest context."
    ...
    8520: SzError,                          # EAS_ERR_SALT_SZSS_INIT_FAILED                                                         "Secure Store initialization failed."
    8521: SzError,                          # EAS_ERR_SALT_SZSS_TOKEN_MUST_BE_INIT                                                  "Hashing with a named salt requires the Secure Store to be initialized."
    8522: SzConfigurationError,             # EAS_ERR_SALT_SZSS_SOPIN_NOT_VALID                                                     "The Security Officer (SO) PIN is not correct."
    8524: SzError,                          # EAS_ERR_SALT_SZSS_INIT_UNKNOWN_EXCEPTION                                              "Secure Store initialization failed with an unrecognized exception"
    8525: SzConfigurationError,             # EAS_ERR_SALT_SZSS_REQUIRED_FOR_LOAD                                                   "Secure Store is required to load salt"
    8526: SzConfigurationError,             # EAS_ERR_SALT_SZSS_REQUIRED_FOR_GENERATE                                               "Secure Store is required to generate salt"
    8527: SzConfigurationError,             # EAS_ERR_SALT_SZSS_REQUIRED_FOR_IMPORT                                                 "Secure Store is required to import salt"
    8528: SzConfigurationError,             # EAS_ERR_SALT_SZSS_REQUIRED_FOR_EXPORT                                                 "Secure Store is required to export salt"
    8529: SzConfigurationError,             # EAS_ERR_SALT_SZSS_REQUIRED_FOR_DELETE                                                 "Secure Store is required to delete salt"
    8530: SzError,                          # EAS_ERR_SALT_CANNOT_OVERWRITE                                                         "You cannot overwrite an existing salt called {0}"
    8536: SzConfigurationError,             # EAS_ERR_SALT_SZSS_REQUIRED_FOR_LEGACY                                                 "Secure Store is required to add a legacy salt"
    8538: SzConfigurationError,             # EAS_ERR_SALT_SZSS_REQUIRED_FOR_METHOD                                                 "Secure Store is required to change hashing method"
    8539: SzError,                          # EAS_ERR_SALT_SZSS_ERROR_CHANGING_METHOD                                               "Secure Store error changing hashing method"
    ...
    9000: SzLicenseError,                   # EAS_LIMIT_MAX_OBS_ENT                                                                 "LIMIT: Maximum number of records ingested: {0}. {1}"
    ...
    9227: SzError,                          # EAS_ERR_FTYPE_CODE_INVALID_FOR_SQL                                                    "Feature type code [{0}] is invalid for use as SQL table name: {1}"
    ...
    9229: SzError,                          # EAS_ERR_SQLITE_VERSION_TOO_OLD                                                        "SQLite version {0} or higher is required (found {1}). RETURNING clause support is needed for efficient redo processing."
    ...
    9250: SzConfigurationError,             # EAS_ERR_SZSS_INVALID_LIB                                                              "Invalid ({1}) Secure Store plug-in library: {0}"
    9251: SzConfigurationError,             # EAS_ERR_SZSS_INVALID_URL                                                              "Invalid Secure Store URL: {0}"
    9252: SzConfigurationError,             # EAS_ERR_SZSS_INVALID_PIN                                                              "Invalid Secure Store credential specification: {0}"
    9253: SzConfigurationError,             # EAS_ERR_SZSS_TOKEN_INIT_FAILED                                                        "Secure Store token initialization failed: {0}."
    9254: SzConfigurationError,             # EAS_ERR_SZSS_TOKEN_UNINITIALIZED                                                      "Cannot open a Secure Store session when the token is uninitialized."
    9255: SzConfigurationError,             # EAS_ERR_SZSS_USER_PIN_UNINITIALIZED                                                   "Secure Store credential is uninitialized."
    9256: SzConfigurationError,             # EAS_ERR_SZSS_SESSION_OPEN                                                             "Cannot open a Secure Store session when one is already open."
    9257: SzConfigurationError,             # EAS_ERR_SZSS_NO_SESSION                                                               "Cannot use Secure Store without a session."
    9258: SzConfigurationError,             # EAS_ERR_SZSS_SESSION_OPEN_FAILED                                                      "Secure Store session could not be opened: {0}."
    9259: SzConfigurationError,             # EAS_ERR_SZSS_ADMIN_LOGIN_FAILED                                                       "Secure Store admin login failed: {0}."
    9260: SzConfigurationError,             # EAS_ERR_SZSS_USER_LOGIN_FAILED                                                        "Secure Store user login failed: {0}."
    9261: SzConfigurationError,             # EAS_ERR_SZSS_PKCS11_ERROR                                                             "Secure Store function failed: {0}"
    9264: SzConfigurationError,             # EAS_ERR_SZSS_LOGOUT_FAILED                                                            "Secure Store logout failed: {0}."
    9265: SzConfigurationError,             # EAS_ERR_SZSS_NEED_RW_SESSION                                                          "Secure Store session must be read/write."
    9266: SzConfigurationError,             # EAS_ERR_SZSS_UNABLE_TO_VERIFY_KEY                                                     "Secure Store key does not meet requirements."
    9267: SzError,                          # EAS_ERR_SZSS_UNABLE_TO_CREATE_KEY                                                     "Secure Store key creation failed."
    9268: SzError,                          # EAS_ERR_SZSS_UNABLE_TO_CHANGE_PIN                                                     "Secure Store password change failed: {0}."
    9269: SzConfigurationError,             # EAS_ERR_SZSS_INVALID_OLD_CREDENTIAL                                                   "Secure Store old credential is invalid."
    9270: SzConfigurationError,             # EAS_ERR_SZSS_INVALID_NEW_CREDENTIAL                                                   "Secure Store new credential is invalid."
    9271: SzError,                          # EAS_ERR_SZSS_OUT_OF_MEMORY                                                            "Secure Store out of memory."
    9272: SzError,                          # EAS_ERR_SZSS_FIND_INIT_FAILED                                                         "Secure Store object locating failed: {0}."
    9273: SzError,                          # EAS_ERR_SZSS_FIND_FAILED                                                              "Secure Store object find failed: {0}."
    9274: SzError,                          # EAS_ERR_SZSS_CRYPTO_SETUP_FAILED                                                      "Secure Store setup of encryption failed: {0}."
    9275: SzError,                          # EAS_ERR_SZSS_ENCRYPT_START_FAILED                                                     "Secure Store unable to start encryption: {0}."
    9276: SzError,                          # EAS_ERR_SZSS_ENCRYPT_SIZE_FAILED                                                      "Secure Store unable to get the size of encrypted data: {0}."
    9277: SzError,                          # EAS_ERR_SZSS_ENCRYPT_FAILED                                                           "Secure Store encryption failed: {0}."
    9278: SzError,                          # EAS_ERR_SZSS_DECRYPT_START_FAILED                                                     "Secure Store unable to start decryption: {0}."
    9279: SzError,                          # EAS_ERR_SZSS_DECRYPT_FAILED                                                           "Secure Store decryption failed: {0}."
    9280: SzError,                          # EAS_ERR_SZSS_OBJECT_SAVE_FAILED                                                       "Secure Store unable to save object: {0}."
    9281: SzError,                          # EAS_ERR_SZSS_OBJECT_DELETE_FAILED                                                     "Secure Store unable to delete object: {0}."
    9282: SzError,                          # EAS_ERR_SZSS_OBJECT_CHANGE_FAILED                                                     "Secure Store unable to modify object: {0}."
    9283: SzError,                          # EAS_ERR_SZSS_UNINITIALIZED                                                            "Secure Store has not been initialized"
    9284: SzConfigurationError,             # EAS_ERR_SZSS_INVALID_SLOT_ID                                                          "Can not obtain info on specified slot. Possibly invalid slot ID specified in Secure Store URL: {0}"
    9285: SzConfigurationError,             # EAS_ERR_SZSS_NO_TOKEN_IN_SLOT                                                         "No security token present in slot specified by Secure Store URL: slot ID = {0}"
    9286: SzConfigurationError,             # EAS_ERR_SZSS_TOKEN_NOT_FOUND                                                          "Can not obtain info for security token. Possibly invalid token label and/or slot ID specified in Secure Store URL: {0}"
    9287: SzError,                          # EAS_ERR_SZSS_TOKEN_IMPL_ERROR                                                         "An internal error occurred in the security token implementation library: Return Code = {0}"
    9288: SzError,                          # EAS_ERR_SZSS_USER_PIN_PROMPT_FAILED                                                   "Was unable to prompt user for security token authentication."
    9289: SzError,                          # EAS_ERR_SZSS_LABEL_CHANGED_SINCE_CONFIG_INIT                                          "Secure Store has been reconfigured since loading."
    9290: SzError,                          # EAS_ERR_SZSS_OBJECT_NOT_FOUND                                                         "Secure Store does not have an object called {0}."
    9292: SzConfigurationError,             # EAS_ERR_SZSS_NO_PASSWORD                                                              "No password supplied"
    9293: SzConfigurationError,             # EAS_ERR_SZSS_NO_SEC_STORE_PREFIX                                                      "Secure Store expects a different format (starting with {0}) when a password is supplied"
    9295: SzConfigurationError,             # EAS_ERR_SZSS_NO_DATA_OBJECTS                                                          "There are no Secure Store objects stored on the token"
    9296: SzConfigurationError,             # EAS_ERR_SZSS_SEC_STORE_ARCHIVE_BAD                                                    "The exported archive appears to be corrupted around object {0}"
    9297: SzConfigurationError,             # EAS_ERR_SZSS_FILE_NOT_FOUND                                                           "Secure Store failed to open {0}"
    9298: SzConfigurationError,             # EAS_ERR_SZSS_FILE_CONTENTS_BAD                                                        "Secure Store contents of {0} not usable."
    9299: SzError,                          # EAS_ERR_SZSS_CLASS_NOT_INIT                                                           "Secure Store internal error."
    9300: SzConfigurationError,             # EAS_ERR_SZSS_PASSWORD_CHECK_ERROR                                                     "Secure Store internal error ({0}) checking password."
    ...
    9406: SzError,                          # EAS_ERR_SZSS_SESSION_MUST_NOT_BE_OPEN                                                 "Secure Store cannot fetch a value with sync if a session is already open."
    9408: SzConfigurationError,             # EAS_ERR_SZSS_PASSWORD_INADEQUATE                                                      "The provided password is not strong enough: {0}"
    9409: SzConfigurationError,             # EAS_ERR_SZSS_FUNCTION_LIST_NOT_SET                                                    "The security token interface is not yet set"
    9410: SzError,                          # EAS_ERR_SZSS_PKCS_INIT_FAILED                                                         "Initializing token driver failed {0}"
    9411: SzError,                          # EAS_ERR_SZSS_PKCS_FINAL_FAILED                                                        "Finalizing token driver failed {0}"
    9413: SzConfigurationError,             # EAS_ERR_SZSS_INCORRECT_PASSWORD                                                       "The export file password appears to be incorrect."
